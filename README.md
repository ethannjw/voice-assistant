...
Elva responds or calls tools only when the latest utterance addresses her by name. When you begin speaking, the application stops only the currently playing audio response. An active coding-agent task continues running.
